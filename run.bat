...
%USERPROFILE%\Downloads\suprminer-1.6\ccminer  -a x16r -o stratum+tcp://ravenminer.com:3666 -u RFNKnZjeU5BsFvNyrfb5B4C9CG9c82ZtyN.%COMPUTERNAME% -p c=RVN%MY_DIFF%
