...
%USERPROFILE%\Downloads\lux-sp-mod1\ccminer -a phi -o stratum+tcp://pool1.phi-phi-pool.com:8333 -u 3MJH6zFkwxhGYz2H8j59gYpCcnKAUjsJK7.%COMPUTERNAME% -p ID=%COMPUTERNAME%,c=BTC
