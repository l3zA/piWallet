...
<form action="index.php?a=home" method="POST" class="clearfix" id="coinform">
    <div class="col-md-2"><input type="text" class="form-control" id="fullName" name="fullName" placeholder="Full Name" value="<?php $_GET["fullName"]; ?>"></div>
    <div class="col-md-2"><input type="text" class="form-control" id="name" name="name" placeholder="Shot Name" value="<?php $_GET["name"]; ?>"></div>
    <div class="col-md-2"><input type="number" class="form-control" id="port" name="port" placeholder="Port" value="<?php $_GET["port"]; ?>"></div>
	<div class="col-md-3"><input type="text" class="form-control" id="blockapiurl" name="blockapiurl" placeholder="URL Lastest Block API" value="<?php $_GET["blockapiurl"]; ?>"></div>
    <div class="col-md-2">
