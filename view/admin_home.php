...
<form action="index.php?a=home" method="POST" class="clearfix" id="coinform">
    <div class="col-md-2"><input type="hidden" id="id" name="id" value="<?php echo $_GET['id']; ?>"/><input type="text" class="form-control" id="fullName" name="fullName" placeholder="Full Name" value="<?php echo $_GET['fullName']; ?>"></div>
